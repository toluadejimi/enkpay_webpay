    ...
    <div class="tf-container">
        <div class="tf-balance-box transfer-amount">
            <div class="top mt-1">
                ...
                <hr>
                <h4 class="text-danger text-center fw_4 mb-3">PLEASE ALWAYS ADD REFERENCE GENERATED <br/> TO YOUR
                    PAYMENT NARRATION / NOTE / REFERENCE BEFORE MAKING TRANSFER</h4>
    ...
    <div class="tf-container">
            ...
            <div id=""
                ...
                <div class="accordion-item border-0">
                    <div class="inner d-flex align-items-center">
                        <svg width="140" height="51" viewBox="0 0 155 61" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div id="opay" class="accordion-collapse collapse"
                        ...
                        <div class="tf-container my-2">
                            ...
                            <a id="openModalBtnopay" class="tf-btn success large" disabled>Continue to make payment</a>
                        </div>
        ...
        @if($palmpay_transfer == 1)
            ...
            <div id=""
                ...
                <div class="accordion-item border-0">
                    <div class="inner d-flex align-items-center">
                        <svg width="140" height="51" viewBox="0 0 188 53" fill="none" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class="content">
                            <h4><a href="#" data-bs-toggle="collapse" data-bs-target="#palmpay"
                                   aria-expanded="false" aria-controls="palmpay" class="fw_6">Click here to get account
                                    details
                                </a>
                            </h4>
                            <p>40 seconds confirmation (recommended)</p>
                                ...
                                <div class="card">
                                    <div class="card-body d-flex justify-content-center">
                                        <div class="row">
                                            ...
                                            <div class="text-center">
                                                <svg width="140" height="51" viewBox="0 0 234 44" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    <rect width="234" height="44" fill="url(#pattern0_2024_16)"/>
                                                    <defs>
                                                        <pattern id="pattern0_2024_16"
                                                                 patternContentUnits="objectBoundingBox" width="1"
                                                                 height="1">
                                                            <use xlink:href="#image0_2024_16"
                                                                 transform="matrix(0.00166604 0 0 0.00869565 0.0615196 -0.00355884)"/>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input style="font-size: 25px" hidden value="{{ $transref }}"
                                                       id="trfkuda">
                        ...
                        <div id=""
                            ...
                            <div class="accordion-item border-0">
                                <div class="inner d-flex align-items-center">
                                    ...
                                    <div class="content">
                                        <h4>
                                            <a href="https://api.whatsapp.com/send?phone=2349036119467&text=Hello there."
                                                class="fw_6"> Instant Payment
                                                Issues only
                                            </a>
                                        </h4>
                                        <p>Get support on instant payment issues channel 1</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id=""
                            ...
                            <div class="accordion-item border-0">
                                <div class="inner d-flex align-items-center">
                                    ...
                                    <div class="content">
                                        <h4>
                                            <a href="https://api.whatsapp.com/send?phone=2348105317336&text=Hello there."
                                                class="fw_6"> Instant Payment
                                                Issues only
                                            </a>
                                        </h4>
                                        <p>Get support on instant payment issues channel 2</p>
                                    </div>
                                </div>
                            </div>
                        </div>
