...
@section('content')
        ...
        <div class="tf-container">
            <div class="tf-balance-box transfer-amount">
                <div class="top mt-1">
                    ...
                    <h1>₦{{ number_format($payable_amount ?? "0", 2) }}</h1>
        ...
        <div class="tf-container">
            <div class="tf-card-block d-flex align-items-center justify-content-between">
                <div class="inner d-flex align-items-center">
                    ...
                    <div class="content">
                        <h4><a href="{{ $pre_link ?? "link" }}" class="fw_6">Pay With Debit Card</a></h4>
            ...
            <div id="" class="accordion border-0 tf-card-block d-flex align-items-center justify-content-between">
                        ...
                        <div class="card border-0">
                            <div class="card-body d-flex justify-content-center">
                                <div class="row">
                                    ...
                                    <input hidden value="{{ $p_account_no ?? "Not Available" }}" id="p_account_no">
                                    ...
                                    <form onsubmit="event.preventDefault()">
                                        ...
                                        <input type="text" id="trx_id" hidden value="{{ $trans_id ?? "0" ?? "0"}}">

                                        <input type="text" id="webHook" hidden value="{{ $webhook ?? "0"}}">

                                        <input type="text" id="Amount" hidden value="{{ $amount ?? 0}}">

                                        <!-- Button trigger modal -->


                                        <!-- Modal -->
                                        <div style="background-image: linear-gradient(to right top, #051937, #001c2d, #001a1c, #02160f, #0e1109);" class="modal fade" id="myModal" data-backdrop="static" data-keyboard="false">
                                            <div class="modal-dialog " style="background-image: linear-gradient(to right top, #051937, #001c2d, #001a1c, #02160f, #0e1109);">
                                                <div class="modal-content border-0" style="background-image: linear-gradient(to right top, #051937, #001c2d, #001a1c, #02160f, #0e1109); background-color: black;">
                                                        ...
                                                        <div class="tf-container p-5">
                                                            ...
                                                            <div class="payment-loader mb-4">
                                                                ...
                                                                <div class="text-center">
                                                                    <hp style="color:rgb(232, 3, 106);" id="timer"><span
                                                                            id="countdown"></span></p>
                                                                </div>
                                                                ...
                                                                <div class="loader-text">
                                                                    <p class="text-center mb-4"
                                                                       style="color:rrgb(11, 1, 63)" id="message"></p>
                                                                </div>
                                                    ...
                                                    <div class="tf-container my-5">
                                                        <a href="decline?trans_id={{ $trans_id ?? "0" }}&key={{ $key ?? "0" ?? "0" }}"
                                        ...
                                        <button class="tf-btn accent large my-3" id="requestButtonp">I
                                            ve sent ₦{{
                                        number_format($payable_amount ?? 0)}}
    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <a href="decline?trans_id={{ $trans_id ?? "0" }}&key={{ $key ?? "0" ?? "0" }}" class="tf-btn danger large">Cancel
                Transaction</a>
        </div>
    </div>
